...
const toggleTurn = () => {
  // TODO: Change current player turn
  // TODO: Update the DOM element with new turn value
  // TODO: Reset and start the player timer again
  // Example:
  // resetTimer();
  // startTimer();
};
...
const startTimer = () => {
  ...
  // - Every second, decrease the timer variable
  // - If timer reaches 0:
  //    * Switch the turn
  //    * Reset the timer
  // - Update the timer value in DOM (element with id="timer")
};
